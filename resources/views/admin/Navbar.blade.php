            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        ...
                        <p></p>
                        <h5>MONITORIA DE PACIENTES NA DD </h5>
                    </div>
                </div>
                    ...
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            <li class="nav-item dropdown">
                                <a href="/pacientes_registados" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span><i class="notika-icon notika-house"></i></span></a>
                                <div role="menu" class="collapse navbar collapse">
